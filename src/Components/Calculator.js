        ...
        return (
            <div className="calculator">
                ...
                <div className="keypad">
                    ...
                    <Key className="key-function" onClick={() => this.negateValue()}>+/-</Key>
                    <Key className="key-function" onClick={() => this.doOperation('%')}>%</Key>
                    <Key className={`key-operation ${operation == '/' ? 'key-active' : ''}`} onClick={() => this.doOperation('/')}>&divide;</Key>

                    <Key className="key-7" onClick={() => this.inputDigit(7)}>7</Key>
                    <Key className="key-8" onClick={() => this.inputDigit(8)}>8</Key>
                    <Key className="key-9" onClick={() => this.inputDigit(9)}>9</Key>
                    <Key className={`key-operation ${operation == '*' ? 'key-active' : ''}`} onClick={() => this.doOperation('*')}>&times;</Key>

                    <Key className="key-4" onClick={() => this.inputDigit(4)}>4</Key>
                    <Key className="key-5" onClick={() => this.inputDigit(5)}>5</Key>
                    <Key className="key-6" onClick={() => this.inputDigit(6)}>6</Key>
                    <Key className={`key-operation ${operation == '-' ? 'key-active' : ''}`} onClick={() => this.doOperation('-')}>-</Key>

                    <Key className="key-1" onClick={() => this.inputDigit(1)}>1</Key>
                    <Key className="key-2" onClick={() => this.inputDigit(2)}>2</Key>
                    <Key className="key-3" onClick={() => this.inputDigit(3)}>3</Key>
                    <Key className={`key-operation ${operation == '+' ? 'key-active' : ''}`} onClick={() => this.doOperation('+')}>+</Key>

                    <Key className="key-0" onClick={() => this.inputDigit(0)}>0</Key>
                    <Key className="key-point" onClick={() => this.inputDecimalPoint()}>.</Key>
                    <Key className="key-equal key-operation" onClick={() => this.doOperation("=")}>=</Key>
                </div>
